...
macro_rules! int_from_vec {
    ( $( $bit:expr ),* $(,)? ) => {{
        0u64 $( | (1u64 << $bit) )*
    }};
}

macro_rules! insert_scale {
...
//todo: combine scales that are split into ascending/descending

pub static TWELVE_TET_SCALES: LazyLock<Vec<ETScale>> = LazyLock::new(|| vec![
    insert_scale! (
        name: String::from("Acoustic"),
        notes: int_from_vec![0, 2, 4, 6, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Adonai Malakh"),
        notes: int_from_vec![0, 1, 2, 3, 5, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Aeolian"),
        notes: int_from_vec![0, 2, 3, 5, 7, 8, 10],
    ),
    insert_scale! (
        name: String::from("Aeolian ♭1"),
        notes: int_from_vec![0, 3, 4, 6, 8, 9, 11],
    ),
    insert_scale! (
        name: String::from("Aeolian Harmonic"),
        notes: int_from_vec![0, 3, 4, 6, 7, 9, 11],
    ),
    insert_scale! (
        name: String::from("Aeolian Major"),
        notes: int_from_vec![0, 2, 4, 5, 7, 8, 10],
    ),
    insert_scale! (
        name: String::from("Aeolian Pentatonic"),
        notes: int_from_vec![0, 2, 3, 7, 8],
    ),
    insert_scale! (
        name: String::from("Ahava Rabba"),
        origin: String::from("Jewish"),
        notes: int_from_vec![0, 1, 3, 4, 5, 6, 8, 10],
    ),
    insert_scale! (
        name: String::from("Ajam Shiram"),
        notes: int_from_vec![0, 2, 4, 5, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 4, 5, 7, 9],
    ),
    insert_scale! (
        name: String::from("Ascending Minor"),
        notes: int_from_vec![0, 2, 3, 5, 7, 9, 11],
    ),
    insert_scale! (
        name: String::from("Augmented"),
        notes: int_from_vec![0, 3, 4, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Augmented Pentatonic"),
        notes: int_from_vec![0, 3, 4, 7, 8],
    ),
    insert_scale! (
        name: String::from("Augmented Pentatonic 2"),
        notes: int_from_vec![0, 4, 6, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 5, 7, 9],
    ),
    insert_scale! (
        name: String::from("Banshikicho"),
        origin: String::from("Japan"),
        notes: int_from_vec![0, 2, 3, 4, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Ethiopia"),
        notes: int_from_vec![0, 3, 5, 7, 10],
    ),
    insert_scale! (
        name: String::from("Bebop Chromatic"),
        notes: int_from_vec![0, 1, 2, 4, 5, 7, 9, 10, 11],
    ),
    insert_scale! (
        name: String::from("Bebop Dorian"),
        notes: int_from_vec![0, 2, 3, 4, 5, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Bebop Half-diminished"),
        notes: int_from_vec![0, 1, 3, 5, 6, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Bebop Harmonic Minor"),
        notes: int_from_vec![0, 2, 3, 5, 7, 8, 10, 11],
    ),
    insert_scale! (
        name: String::from("Bebop Locrian"),
        notes: int_from_vec![0, 1, 3, 5, 6, 7, 8, 10],
    ),
    insert_scale! (
        name: String::from("Bebop Major"),
        notes: int_from_vec![0, 2, 4, 5, 7, 8, 9, 11],
    ),
    insert_scale! (
        name: String::from("Bebop Major Heptatonic"),
        notes: int_from_vec![0, 2, 4, 5, 7, 8, 9],
    ),
    insert_scale! (
        name: String::from("Bebop Major Hexatonic"),
        notes: int_from_vec![0, 2, 4, 7, 8, 9],
    ),
    insert_scale! (
        name: String::from("Bebop Melodic Minor"),
        notes: int_from_vec![0, 2, 3, 5, 7, 8, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 4, 5, 7, 9, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 3, 7, 8],
    ),
    insert_scale! (
        name: String::from("Blues Dorian Hexatonic"),
        notes: int_from_vec![0, 1, 3, 4, 7, 9],
    ),
    insert_scale! (
        name: String::from("Blues Enneatonic"),
        notes: int_from_vec![0, 2, 3, 4, 5, 7, 9, 10, 11],
    ),
    insert_scale! (
        name: String::from("Blues Enneatonic 2"),
        notes: int_from_vec![0, 2, 3, 4, 5, 6, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Blues Heptatonic"),
        notes: int_from_vec![0, 2, 3, 5, 6, 9, 10],
    ),
    insert_scale! (
        name: String::from("Blues Heptatonic 2"),
        notes: int_from_vec![0, 3, 5, 6, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Blues Leading Tone"),
        notes: int_from_vec![0, 3, 5, 6, 7, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 3, 5, 8, 10],
    ),
    insert_scale! (
        name: String::from("Blues Minor Maj7"),
        notes: int_from_vec![0, 3, 5, 6, 7, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 3, 4, 5, 6, 7, 10],
    ),
    insert_scale! (
        name: String::from("Blues Modified"),
        notes: int_from_vec![0, 2, 3, 5, 6, 7, 10],
    ),
    insert_scale! (
        name: String::from("Blues Octatonic"),
        notes: int_from_vec![0, 2, 3, 5, 6, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Blues (or Blues Hexatonic)"),
        notes: int_from_vec![0, 3, 5, 6, 7, 10],
    ),
    insert_scale! (
        name: String::from("Blues Phrygian"),
        notes: int_from_vec![0, 1, 3, 5, 6, 7, 10],
    ),
    insert_scale! (
        name: String::from("Buzurg"),
        notes: int_from_vec![0, 1, 4, 5, 6, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 3, 4, 5, 8],
    ),
    insert_scale! (
        name: String::from("Chad Gadyo"),
        origin: String::from("Jewish"),
        notes: int_from_vec![0, 2, 3, 5, 7],
    ),
    insert_scale! (
        name: String::from("Chaio"),
        notes: int_from_vec![0, 2, 5, 8, 10],
    ),
    insert_scale! (
        name: String::from("Chin"),
        notes: int_from_vec![0, 3, 6, 8, 10],
    ),
    insert_scale! (
        name: String::from("Chinese"),
        origin: String::from("China"),
        notes: int_from_vec![0, 4, 6, 7, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 3, 6, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 3, 5, 6, 8, 9, 11],
    ),
    insert_scale! (
        name: String::from("Diminished Half-tone"),
        notes: int_from_vec![0, 1, 3, 4, 6, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Diminished Pentatonic"),
        notes: int_from_vec![0, 3, 6, 8, 11],
    ),
    insert_scale! (
        name: String::from("Dominant Pentatonic"),
        notes: int_from_vec![0, 2, 4, 7, 10],
    ),
    insert_scale! (
        name: String::from("Dorian"),
        notes: int_from_vec![0, 2, 3, 5, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Dorian ♯4"),
        notes: int_from_vec![0, 2, 3, 6, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Dorian Aeolian"),
        notes: int_from_vec![0, 2, 3, 5, 7, 8, 9, 10],
    ),
    insert_scale! (
        name: String::from("Dorian ♭2"),
        notes: int_from_vec![0, 1, 3, 5, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Dorian ♭2 ♭4"),
        notes: int_from_vec![0, 1, 3, 4, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Dorian ♭2 Maj7"),
        notes: int_from_vec![0, 1, 3, 4, 6, 9, 11],
    ),
    insert_scale! (
        name: String::from("Dorian ♭5"),
        notes: int_from_vec![0, 2, 3, 5, 6, 9, 10],
    ),
    insert_scale! (
        name: String::from("Dorian ♭9"),
        notes: int_from_vec![0, 1, 3, 5, 6, 9, 10],
    ),
    insert_scale! (
        name: String::from("Dorian ♭9 ♯11"),
        notes: int_from_vec![0, 1, 3, 6, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Dorian Pentatonic"),
        notes: int_from_vec![0, 2, 3, 7, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 3, 6, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Double Phrygian"),
        notes: int_from_vec![0, 1, 3, 5, 6, 9],
    ),
    insert_scale! (
        name: String::from("Egyptian"),
        origin: String::from("Egypt"),
        notes: int_from_vec![0, 2, 5, 7, 10],
    ),
    insert_scale! (
        name: String::from("Enigmatic"),
        notes_ascending: int_from_vec![0, 1, 4, 6, 8, 10, 11],
        notes_descending: int_from_vec![0, 1, 4, 5, 8, 10, 11],
    ),
    insert_scale! (
        name: String::from("Enigmatic Minor"),
        notes: int_from_vec![0, 1, 3, 6, 8, 10, 11],
    ),
    insert_scale! (
        name: String::from("Enigmatic Mixed"),
        notes: int_from_vec![0, 1, 4, 5, 6, 8, 10, 11],
    ),
    insert_scale! (
        name: String::from("Eskimo Hexatonic"),
        origin: String::from("Alaska"),
        notes: int_from_vec![0, 2, 4, 6, 8, 9],
    ),
    insert_scale! (
        name: String::from("Eskimo Hexatonic 2"),
        origin: String::from("Alaska"),
        notes: int_from_vec![0, 2, 4, 6, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 3, 4, 5, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 3, 5, 7, 8, 9, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 3, 4, 5, 7, 8, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 4, 5, 6, 7, 9, 11],
    ),
    insert_scale! (
        name: String::from("Genus Secundum"),
        notes: int_from_vec![0, 4, 5, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 4, 5, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Gregorian 3"),
        notes: int_from_vec![0, 1, 3, 5, 7, 8, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        name: String::from("Gu"),
        origin: String::from("China"),
        notes: int_from_vec![0, 2, 4, 6, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Hungary"),
        notes: int_from_vec![0, 1, 5, 6, 8, 9, 10],
    ),
    insert_scale! (
        name: String::from("Gypsy Hexatonic"),
        origin: String::from("Hungarian"),
        notes: int_from_vec![0, 1, 4, 5, 7, 8, 9],
    ),
    insert_scale! (
        name: String::from("Gypsy Hexatonic Inverse"),
        origin: String::from("Hungary"),
        notes: int_from_vec![0, 3, 4, 5, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Gypsy Inverse"),
        origin: String::from("Hungary"),
        notes: int_from_vec![0, 1, 4, 5, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 5, 7, 8],
    ),
    insert_scale! (
        name: String::from("Harmonic Major"),
        notes: int_from_vec![0, 2, 4, 5, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Harmonic Major 2"),
        notes: int_from_vec![0, 2, 4, 5, 8, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 3, 5, 7, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        name: String::from("Harmonic Minor ♭5"),
        notes: int_from_vec![0, 2, 3, 5, 6, 8, 11],
    ),
    insert_scale! (
        name: String::from("Harmonic Minor Inverse"),
        notes: int_from_vec![0, 1, 4, 5, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Harmonic Neapolitan Minor"),
        origin: String::from("Italy"),
        notes: int_from_vec![0, 1, 2, 3, 5, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Hawaiian"),
        origin: String::from("Hawaii"),
        notes: int_from_vec![0, 2, 3, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Japan"),
        notes: int_from_vec![0, 1, 3, 5, 6, 10],
    ),
    insert_scale! (
        name: String::from("Hon-Kumoi-Joshi"),
        origin: String::from("Japan"),
        notes: int_from_vec![0, 1, 5, 6, 10],
    ),
    insert_scale! (
        name: String::from("Houseini"),
        origin: String::from("Greece"),
        notes: int_from_vec![0, 2, 3, 4, 5, 7, 8, 9, 10],
    ),
    insert_scale! (
        name: String::from("Houzam (or Huzam)"),
        origin: String::from("Greece"),
        notes: int_from_vec![0, 3, 4, 5, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Hungary"),
        notes: int_from_vec![0, 3, 4, 6, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Hungarian Major Inverse"),
        origin: String::from("Hungary"),
        notes: int_from_vec![0, 2, 3, 5, 6, 8, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        name: String::from("Hungarian Minor ♭2"),
        origin: String::from("Hungary"),
        notes: int_from_vec![0, 1, 2, 3, 6, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Hungarian Minor Inverse"),
        origin: String::from("Hungary"),
        notes: int_from_vec![0, 1, 4, 5, 6, 9, 10],
    ),
    insert_scale! (
        name: String::from("Hybrid Pentatonic"),
        notes: int_from_vec![0, 3, 5, 7, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Japan"),
        notes: int_from_vec![0, 1, 5, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 4, 5, 8, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 3, 4, 5, 8, 9, 11],
    ),
    insert_scale! (
        name: String::from("Ionian Augmented ♭9"),
        notes: int_from_vec![0, 1, 4, 5, 8, 9, 11],
    ),
    insert_scale! (
        name: String::from("Ionian ♭5"),
        notes: int_from_vec![0, 2, 4, 5, 6, 9, 11],
    ),
    insert_scale! (
        name: String::from("Ionian Pentatonic"),
        notes: int_from_vec![0, 4, 5, 7, 11],
    ),
    insert_scale! (
        name: String::from("Istrian"),
        origin: String::from("Croatia"),
        notes: int_from_vec![0, 1, 3, 4, 6, 7],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 3, 5, 6, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 5, 7, 10],
    ),
    insert_scale! (
        name: String::from("John Found's Mantra Of Will"),
        notes: int_from_vec![0, 1, 4, 6, 7, 8, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Greece"),
        notes: int_from_vec![0, 2, 3, 5, 6, 7, 8, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 4, 6, 8, 10, 11],
    ),
    insert_scale! (
        name: String::from("Leading Whole-Tone Inverse"),
        notes: int_from_vec![0, 1, 2, 4, 6, 8, 10],
    ),
    insert_scale! (
        name: String::from("LG Octatonic"),
        notes: int_from_vec![0, 1, 3, 4, 5, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Locrian"),
        notes: int_from_vec![0, 1, 3, 5, 6, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        name: String::from("Locrian ♭4"),
        notes: int_from_vec![0, 1, 3, 4, 6, 8, 10],
    ),
    insert_scale! (
        name: String::from("Locrian 𝄫3 𝄫7"),
        notes: int_from_vec![0, 1, 2, 5, 6, 8, 9],
    ),
    insert_scale! (
        name: String::from("Locrian 𝄫7"),
        notes: int_from_vec![0, 1, 3, 5, 6, 8, 9],
    ),
    insert_scale! (
        name: String::from("Locrian Dominant"),
        notes: int_from_vec![0, 1, 4, 5, 6, 8, 10],
    ),
    insert_scale! (
        name: String::from("Locrian Maj7"),
        notes: int_from_vec![0, 1, 3, 5, 6, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 3, 4, 6, 7, 10, 11],
    ),
    insert_scale! (
        name: String::from("Lydian ♯2 Hexatonic"),
        notes: int_from_vec![0, 3, 4, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 4, 6, 7, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 5, 6, 8, 9, 11],
    ),
    insert_scale! (
        name: String::from("Lydian Augmented Dominant"),
        notes: int_from_vec![0, 2, 4, 6, 8, 9, 10],
    ),
    insert_scale! (
        name: String::from("Lydian ♭3"),
        notes: int_from_vec![0, 2, 3, 6, 7, 9, 11],
    ),
    insert_scale! (
        name: String::from("Lydian ♭7"),
        notes: int_from_vec![0, 2, 4, 6, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        name: String::from("Lydian Dominant ♭6"),
        notes: int_from_vec![0, 2, 4, 6, 7, 8, 10],
    ),
    insert_scale! (
        name: String::from("Lydian Hexatonic"),
        notes: int_from_vec![0, 2, 4, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 4, 5, 6, 7, 9, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Jewish"),
        notes: int_from_vec![0, 1, 3, 4, 6, 8, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 3, 5, 7, 8, 10],
    ),
    insert_scale! (
        name: String::from("Major Locrian"),
        notes: int_from_vec![0, 2, 4, 5, 6, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 3, 4, 5, 7, 8, 9, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        name: String::from("Major Pentatonic ♭2"),
        notes: int_from_vec![0, 1, 4, 7, 9],
    ),
    insert_scale! (
        name: String::from("Major Pentatonic ♭2 ♭5"),
        notes: int_from_vec![0, 1, 4, 6, 9],
    ),
    insert_scale! (
        name: String::from("Major Pentatonic ♭3"),
        notes: int_from_vec![0, 1, 3, 6, 9],
    ),
    insert_scale! (
        name: String::from("Major Pentatonic ♭6"),
        notes: int_from_vec![0, 2, 4, 7, 8],
    ),
    insert_scale! (
        name: String::from("Major Pentatonic ♭7 ♯9"),
        notes: int_from_vec![0, 3, 4, 7, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Iraq"),
        notes: int_from_vec![0, 1, 4, 5, 7, 8, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Iraq"),
        notes: int_from_vec![0, 1, 3, 4, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Iraq"),
        notes: int_from_vec![0, 1, 3, 4, 5, 6, 9, 10],
    ),
    insert_scale! (
        name: String::from("Maqam Shahnaz (or Shahnaz Kurdi)"),
        origin: String::from("Iraq"),
        notes: int_from_vec![0, 1, 3, 5, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Maqam Shawq Afza"),
        origin: String::from("Iraq"),
        notes: int_from_vec![0, 2, 3, 4, 5, 6, 7, 8, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Iraq"),
        notes: int_from_vec![0, 1, 3, 4, 5, 6, 7, 8, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 6, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 4, 5, 7, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 4, 6, 7, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 6, 7, 10, 11],
    ),
    insert_scale! (
        name: String::from("Mela Gamanasrama"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 6, 7, 9, 11],
    ),
    insert_scale! (
        name: String::from("Mela Ganamurti"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 5, 7, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 6, 7, 8, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 5, 7, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 5, 7, 8, 9],
    ),
    insert_scale! (
        name: String::from("Mela Jyotisvarupini"),
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 4, 6, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 6, 7, 8, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 5, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 6, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Mela Manavati"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 5, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 5, 7, 10, 11],
    ),
    insert_scale! (
        name: String::from("Mela Namanarayani"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 6, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 6, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Mela Nitimati"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 6, 7, 10, 11],
    ),
    insert_scale! (
        name: String::from("Mela Pavani"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 6, 7, 9, 11],
    ),
    insert_scale! (
        name: String::from("Mela Ragavardhani"),
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 4, 5, 7, 8, 10],
    ),
    insert_scale! (
        name: String::from("Mela Raghupriya"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 6, 7, 10, 11],
    ),
    insert_scale! (
        name: String::from("Mela Ramapriya"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 6, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 5, 7, 8, 10],
    ),
    insert_scale! (
        name: String::from("Mela Rupavati"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 5, 7, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 6, 7, 8, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 6, 7, 9, 11],
    ),
    insert_scale! (
        name: String::from("Mela Syamalangi"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 6, 7, 8, 9],
    ),
    insert_scale! (
        name: String::from("Mela Tenarupi"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 5, 7, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 4, 5, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 5, 7, 10, 11],
    ),
    insert_scale! (
        name: String::from("Mela Venaspati"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 5, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Mela Visvambhari"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 6, 7, 10, 11],
    ),
    insert_scale! (
        name: String::from("Mela Yagapriya"),
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 4, 5, 7, 8, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 3, 6, 7, 9],
    ),
    insert_scale! (
        name: String::from("Messiaen 3rd Mode"),
        notes: int_from_vec![0, 2, 3, 4, 6, 7, 8, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 2, 5, 6, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Messiaen 4th Mode Inverse"),
        notes: int_from_vec![0, 3, 4, 5, 6, 9, 10, 11],
    ),
    insert_scale! (
        name: String::from("Messiaen 5th Mode"),
        notes: int_from_vec![0, 1, 5, 6, 7, 11],
    ),
    insert_scale! (
        name: String::from("Messiaen 5th Mode Inverse"),
        notes: int_from_vec![0, 4, 5, 6, 10, 11],
    ),
    insert_scale! (
        name: String::from("Messiaen 6th Mode"),
        notes: int_from_vec![0, 2, 4, 5, 6, 8, 10, 11],
    ),
    insert_scale! (
        name: String::from("Messiaen 6th Mode Inverse"),
        notes: int_from_vec![0, 1, 2, 4, 6, 7, 8, 10],
    ),
    insert_scale! (
        name: String::from("Messiaen 7th Mode"),
        notes: int_from_vec![0, 1, 2, 3, 5, 6, 7, 8, 9, 11],
    ),
    insert_scale! (
        name: String::from("Messiaen 7th Mode Inverse"),
        notes: int_from_vec![0, 2, 3, 4, 5, 6, 8, 9, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 3, 5, 7, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        name: String::from("Minor Pentatonic 7 ♭5"),
        notes: int_from_vec![0, 3, 5, 6, 10],
    ),
    insert_scale! (
        name: String::from("Minor Pentatonic with Leading Tones"),
        notes: int_from_vec![0, 2, 3, 4, 5, 6, 7, 9, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 3, 4, 6, 8, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 4, 5, 8, 9, 10],
    ),
    insert_scale! (
        name: String::from("Mixolydian Augmented Maj9"),
        notes: int_from_vec![0, 1, 4, 5, 8, 9, 10],
    ),
    insert_scale! (
        name: String::from("Mixolydian ♭2 (or Mixolydian ♭9)"),
        notes: int_from_vec![0, 1, 4, 5, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Mixolydian ♭5"),
        notes: int_from_vec![0, 2, 4, 5, 6, 9, 10],
    ),
    insert_scale! (
        name: String::from("Mixolydian ♭6 (or Mixolydian ♭13)"),
        notes: int_from_vec![0, 2, 4, 5, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 2, 5, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Mixolydian Hexatonic 2"),
        notes: int_from_vec![0, 2, 4, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Spain"),
        notes: int_from_vec![0, 1, 3, 4, 5, 7, 8, 10, 11],
    ),
    insert_scale! (
        name: String::from("Naka Zora"),
        origin: String::from("Japan"),
        notes: int_from_vec![0, 1, 5, 7, 8],
    ),
    insert_scale! (
    ...
    insert_scale! (
        name: String::from("Neapolitan Major ♭4"),
        origin: String::from("Italy"),
        notes: int_from_vec![0, 1, 3, 4, 7, 9, 11],
    ),
    insert_scale! (
        name: String::from("Neapolitan Major ♭5"),
        notes: int_from_vec![0, 1, 3, 5, 6, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Greece"),
        notes: int_from_vec![0, 1, 3, 6, 7, 8, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Japan"),
        notes: int_from_vec![0, 2, 5, 7, 8, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 3, 4, 5, 6, 7, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("China"),
        notes: int_from_vec![0, 1, 4, 5, 6, 9, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 4, 6, 7, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        name: String::from("Phrygian Aeolian ♭4"),
        notes: int_from_vec![0, 1, 2, 3, 5, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        name: String::from("Phrygian ♭4"),
        notes: int_from_vec![0, 1, 3, 4, 7, 8, 10],
    ),
    insert_scale! (
        name: String::from("Phrygian ♭4 Maj7"),
        notes: int_from_vec![0, 1, 3, 4, 7, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 3, 5, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 3, 5, 6, 8, 10, 11],
    ),
    insert_scale! (
        name: String::from("Prometheus"),
        notes: int_from_vec![0, 2, 4, 6, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Italy"),
        notes: int_from_vec![0, 1, 4, 6, 9, 10],
    ),
    insert_scale! (
        name: String::from("Puravi ♭6"),
        notes: int_from_vec![0, 1, 4, 6, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Pyeong Jo"),
        origin: String::from("Korea"),
        notes: int_from_vec![0, 2, 5, 9, 10],
    ),
    insert_scale! (
        name: String::from("Pygmy"),
        notes: int_from_vec![0, 2, 3, 7, 10],
    ),
    insert_scale! (
        name: String::from("Pyramid Hexatonic"),
        notes: int_from_vec![0, 2, 3, 5, 6, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 6, 7, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 5, 7, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 5, 8],
    ),
    insert_scale! (
        name: String::from("Raga Bahar"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 5, 7, 9, 10, 11],
    ),
    insert_scale! (
        name: String::from("Raga Bahudari"),
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 5, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 7, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 5, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 5, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Raga Bhinna Shadj"),
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 5, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes_ascending: int_from_vec![0, 1, 4, 7, 8],
        notes_descending: int_from_vec![0, 1, 4, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Raga Brindabani (or Brindabani Serang)"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 5, 7, 10, 11],
    ),
    insert_scale! (
        name: String::from("Raga Budhamanohari"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 5, 7],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 6, 7, 11],
    ),
    insert_scale! (
        name: String::from("Raga Chaya Todi"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 6, 8],
    ),
    insert_scale! (
        name: String::from("Raga Chaya Vati"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 5, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 6, 7, 8, 9, 10],
    ),
    insert_scale! (
        name: String::from("Raga Chitthakarshini"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 5, 8],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 6, 7, 8],
    ),
    insert_scale! (
        name: String::from("Raga Dhavalashri"),
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 6, 7, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 5, 6, 7],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 4, 5, 8, 9, 10],
    ),
    insert_scale! (
        name: String::from("Raga Gamakakriya"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 6, 7, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 5, 7, 10],
    ),
    insert_scale! (
        name: String::from("Raga Gangatarangini"),
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 5, 6, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 5, 7, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 5, 7, 11],
    ),
    insert_scale! (
        name: String::from("Raga Gauri Velavali"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 5, 7, 9],
    ),
    insert_scale! (
        name: String::from("Raga Gaurikriya"),
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 6, 7, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 5, 8, 11],
    ),
    insert_scale! (
        name: String::from("Raga Girija"),
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 5, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 6, 7, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes_ascending: int_from_vec![0, 1, 5, 7, 11],
        notes_descending: int_from_vec![0, 1, 4, 5, 7, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 6, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 7, 11],
    ),
    insert_scale! (
        name: String::from("Raga Hamsadhvani 2"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 7, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 6, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 6, 8, 9],
    ),
    insert_scale! (
        name: String::from("Raga Hindol"),
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 6, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 6, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 5, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 6, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 7, 8, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 5, 7, 8, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 5, 7, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 5, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Raga Kamalamanohari 2"),
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 5, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes_ascending: int_from_vec![0, 4, 5, 7, 11],
        notes_descending: int_from_vec![0, 2, 4, 5, 7, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes_ascending: int_from_vec![0, 4, 5, 7, 9, 10, 11],
        notes_descending: int_from_vec![0, 2, 4, 5, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 8, 11],
    ),
    insert_scale! (
        name: String::from("Raga Kumudki"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 6, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 5, 8, 11],
    ),
    insert_scale! (
        name: String::from("Raga Lalita Bhairav"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 5, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 7, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 6, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 5, 7, 9, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes_ascending: int_from_vec![0, 1, 5, 7, 8],
        notes_descending: int_from_vec![0, 1, 4, 5, 7, 8],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 6, 7, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 5, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Raga Malayamarutam"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 5, 7, 8, 9],
    ),
    insert_scale! (
        name: String::from("Raga Malkauns"),
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 5, 8, 10, 11],
    ),
    insert_scale! (
        name: String::from("Raga Mamata"),
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 7, 9, 11],
    ),
    insert_scale! (
        name: String::from("Raga Manaranjani"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 7, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Raga Mand"),
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 5, 7, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 5, 11],
    ),
    insert_scale! (
        name: String::from("Raga Megharanjani"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 5, 8],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 4, 7, 9],
    ),
    insert_scale! (
        name: String::from("Raga Mruganandana"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 6, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 6, 7, 11],
    ),
    insert_scale! (
        name: String::from("Raga Nabhomani"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 6, 7],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 5, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes_ascending: int_from_vec![0, 3, 4, 5, 7, 10, 11],
        notes_descending: int_from_vec![0, 3, 5, 7, 11],
    ),
    insert_scale! (
        name: String::from("Raga Nattaikurinji"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 5, 9, 10],
    ),
    insert_scale! (
        name: String::from("Raga Navamanohari"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 5, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 6, 8, 9],
    ),
    insert_scale! (
        name: String::from("Raga Neroshta"),
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 6, 11, 13],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 6, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 5, 7, 8, 11],
    ),
    insert_scale! (
        name: String::from("Raga Pahadi"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 5, 7, 8, 9, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes_ascending: int_from_vec![0, 4, 5, 7, 8, 11],
        notes_descending: int_from_vec![0, 1, 4, 5, 7, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 5, 7, 8],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 5, 9, 10, 11],
    ),
    insert_scale! (
        name: String::from("Raga Ramakri"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 5, 6, 7, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 6, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 4, 6, 7, 11],
    ),
    insert_scale! (
        name: String::from("Raga Rasavali"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 5, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 5, 9, 10],
    ),
    insert_scale! (
        name: String::from("Raga Rukmangi"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 7, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 4, 6, 7, 8, 9],
    ),
    insert_scale! (
        name: String::from("Raga Sarasanana"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 5, 8, 11],
    ),
    insert_scale! (
        name: String::from("Raga Sarasvati"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 6, 7, 9, 10],
    ),
    insert_scale! (
        name: String::from("Raga Saravati"),
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 5, 7, 8, 9],
    ),
    insert_scale! (
        name: String::from("Raga Saugandhini"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 6, 7, 8],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 4, 5, 7, 8, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 5, 7, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 6, 7, 9],
    ),
    insert_scale! (
        name: String::from("Raga Shubravarni"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 6, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 3, 4, 5, 7, 8, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 5, 7, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 5, 9, 11],
    ),
    insert_scale! (
        name: String::from("Raga Sorati"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 5, 7, 9, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 5, 8, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 5, 7, 8],
    ),
    insert_scale! (
        name: String::from("Raga Suddha Todi"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 5, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 6, 7, 8],
    ),
    insert_scale! (
        name: String::from("Raga Takka"),
        origin: String::from("India"),
        notes: int_from_vec![0, 3, 5, 7, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 7, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes_ascending: int_from_vec![0, 4, 5, 9, 11],
        notes_descending: int_from_vec![0, 1, 4, 5, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes_ascending: int_from_vec![0, 4, 5, 7, 9, 10],
        notes_descending: int_from_vec![0, 1, 4, 5, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 3, 6, 7, 9],
    ),
    insert_scale! (
        name: String::from("Raga Vijayasri"),
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 2, 6, 7, 11],
    ),
    insert_scale! (
        name: String::from("Raga Vijayavasanta"),
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 6, 7, 10, 11],
    ),
    insert_scale! (
        name: String::from("Raga Vilasini"),
        origin: String::from("India"),
        notes: int_from_vec![0, 2, 4, 5, 7, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("India"),
        notes: int_from_vec![0, 1, 3, 5, 8, 11],
    ),
    insert_scale! (
        name: String::from("Raga Vutari"),
        origin: String::from("India"),
        notes: int_from_vec![0, 4, 6, 7, 9, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Greece"),
        notes: int_from_vec![0, 2, 3, 4, 7, 8, 10],
    ),
    insert_scale! (
        name: String::from("Sabach Maj7"),
        origin: String::from("Greece"),
        notes: int_from_vec![0, 2, 3, 4, 7, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        name: String::from("Semilocrian ♭4"),
        notes: int_from_vec![0, 2, 3, 4, 6, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Japan"),
        notes: int_from_vec![0, 1, 3, 4, 6, 10],
    ),
    insert_scale! (
        name: String::from("Shostakovich"),
        origin: String::from("Russia"),
        notes: int_from_vec![0, 1, 3, 4, 6, 7, 9, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Spain"),
        notes: int_from_vec![0, 3, 4, 5, 6, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 3, 4, 6, 9, 10],
    ),
    insert_scale! (
        name: String::from("Superlocrian 𝄫3"),
        notes: int_from_vec![0, 1, 2, 4, 6, 8, 10],
    ),
    insert_scale! (
        name: String::from("Superlocrian 𝄫6 𝄫7"),
        notes: int_from_vec![0, 1, 3, 4, 6, 7, 9],
    ),
    insert_scale! (
        name: String::from("Superlocrian Maj7"),
        notes: int_from_vec![0, 1, 3, 4, 6, 8, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 2, 4, 5, 6, 7, 8, 10, 11],
    ),
    insert_scale! (
        name: String::from("Symmetrical Nonatonic"),
        notes: int_from_vec![0, 1, 2, 4, 6, 7, 8, 10, 11],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        origin: String::from("Japan"),
        notes: int_from_vec![0, 2, 3, 6, 8, 11],
    ),
    insert_scale! (
        name: String::from("Takemitzu Tree 2"),
        origin: String::from("Japan"),
        notes: int_from_vec![0, 2, 3, 6, 8, 10],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 2, 6, 7, 8],
    ),
    insert_scale! (
    ...
    insert_scale! (
        name: String::from("Ultralocrian 𝄫3"),
        notes: int_from_vec![0, 1, 2, 4, 6, 8, 9],
    ),
    insert_scale! (
        name: String::from("Ultraphrygian"),
        notes: int_from_vec![0, 1, 3, 4, 7, 8, 9],
    ),
    insert_scale! (
    ...
    insert_scale! (
        ...
        notes: int_from_vec![0, 1, 3, 5, 6, 7, 9, 11],
    ),
    insert_scale! (
