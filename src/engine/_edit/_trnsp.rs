...
#[duplicate_item(
    ...
    [v_multi]  [buttons]  [i_del_vec] [Vec<Option<i64>>] [v_multi_trnsp_all_change_i_deltas] [v_multi_trnsp_one_change_i_deltas] [trnsp_all_change_i_deltas] [trnsp_one_change_i_deltas];
    [f_multi]  [buttons]  [i_del_vec] [Vec<Option<i64>>] [f_multi_trnsp_all_change_i_deltas] [f_multi_trnsp_one_change_i_deltas] [trnsp_all_change_i_deltas] [trnsp_one_change_i_deltas];
    [c_multi]  [combos]   [i_del_vec] [Vec<Option<i64>>] [c_multi_trnsp_all_change_i_deltas] [c_multi_trnsp_one_change_i_deltas] [trnsp_all_change_i_deltas] [trnsp_one_change_i_deltas];
